...
let
  # Create a config option to enable/disable hyprland, that is set in yosai/configuration.nix
  cfg = config.suzu.desktop.hyprland;
in
{
  ...
  # Make it so it will only use the config below if the option is set to true
  options.suzu.desktop.hyprland = {
