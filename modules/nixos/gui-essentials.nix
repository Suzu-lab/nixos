...
let
  cfg = config.suzu.system.guiEssentials;
in
{
  options.suzu.system.guiEssentials.enable =
    lib.mkEnableOption "Core desktop services (portals, greetd, polkit, dbus, keyring)";
